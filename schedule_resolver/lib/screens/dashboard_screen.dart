      ...
      body: Padding(
        ...
        child: Column(
          children: [
                    ...
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (_) => const RecommendationScreen())),
                            child: const Text('View Recommendation Data'))
                      ],
            ...
            Expanded(
                child: sortedTasks.isEmpty ? const Center(child: Text('No added task yet'))
                : ListView.builder(
            ...
            if(sortedTasks.isNotEmpty)
              ElevatedButton(onPressed: aiService.isLoading ? null : () => aiService.analyzeSchedule(scheduleProvider.task),
              child: aiService.isLoading ? const CircularProgressIndicator() : const Text('Resolve Conflicts with Ailyn'),
              )
          ],
        ),
      ),
      floatingActionButton: FloatingActionButton(
          onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => TaskInputScreen())),
